            ...
            try
            {
                ...
                for (var i = 1; i <= sheetcount; i++)
                {
                    ...
                    for (var j = 0; j < sourcedt.Columns.Count; j++)
                    {
                        ...
                        {
                            case 0:
                                row.CreateCell(j).SetCellValue("Bom物料编码");
                                break;
                            case 1:
                                row.CreateCell(j).SetCellValue("Bom物料名称");
                                break;
                            case 2:
                                row.CreateCell(j).SetCellValue("清漆物料编码");
                                break;
                            case 3:
                                row.CreateCell(j).SetCellValue("清漆物料名称");
                                break;
                            case 4:
                                row.CreateCell(j).SetCellValue("干剂物料编码");
                                break;
                            case 5:
                                row.CreateCell(j).SetCellValue("干剂物料名称");
                                break;
                            case 6:
                                row.CreateCell(j).SetCellValue("稀释剂物料编码");
                                break;
                            case 7:
                                row.CreateCell(j).SetCellValue("稀释剂物料名称");
                                break;
                        }
                    }
